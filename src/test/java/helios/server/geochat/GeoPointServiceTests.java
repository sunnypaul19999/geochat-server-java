...
public class GeoPointServiceTests {
  ...
  public void init() {
    ...
    newUserLocationDTO = new UserLocationDTO(33.677303229900822, 86.94993375397198);
  }
  ...
  public void testGeoPointExists() {
    ...
    if (!(expectedPlusCode.equals(registeredPlusCode))) {
      ...
      Assertions.fail(String.format("Expected GeoPoint plus-code %s but got %s", expectedPlusCode, registeredPlusCode));
    }
  }
}
